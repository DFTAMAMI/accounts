...
public class InterestRateController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<InterestRateRQRS> obtainByCode(@PathVariable String id) {
    ...
    @PutMapping("/{id}")
    public  ResponseEntity<InterestRateRQRS> update(@PathVariable String id, @RequestBody InterestRateRQRS interestrate) {
        try {
